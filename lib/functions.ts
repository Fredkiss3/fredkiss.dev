import type {Experience, MarkdownData, Project, Skill} from "./types";
...
export function getSkills(): Promise<MarkdownData<Skill>[]> {
  return readMarkdownFiles<Skill>("data", "skills");
}
