...
With the help of a designer I worked on the redesign of the website from the [old one](https://nautscan.com) to the [new one](https://explorer.modular.cloud). I was also tasked to work on improving the code structure of the app and assure its maintainability.
