...
I also Worked on implementing a port of the app to Electron to distribute the app so that developpers could run a local version of the app, you can find a running demo of the electron app [here](https://github.com/Fredkiss3/fredkiss.dev/assets/38298743/0a313f2d-2c91-4c04-b105-fb52e566909a).
